...
\graphicspath{{assets/titanic/plots/}}
...
\tablePlaceholder{Tabela 3.2 — Identificação e classificação das variáveis:\\
insira aqui o screenshot da tabela de variáveis do notebook (Seção 3.2)}
\label{tab:variaveis}
...
\tablePlaceholder{Tabela 2.2.1 — Composição do índice de correção monetária
(1912→2024):\\
insira aqui o screenshot da tabela de inflação do notebook (Seção 2.2.1)}
\label{tab:inflacao}
...
\tablePlaceholder{Tabela 2.4 — Distribuição por faixa etária
(Criança / Jovem / Adulto / Idoso):\\
insira aqui o screenshot da tabela de faixas etárias do notebook (Seção 2.4)}
\label{tab:faixas}
...
\tablePlaceholder{Tabela 3.1 — Estatísticas descritivas completas
(contagem, média, desvio-padrão, mín., Q1, mediana, Q3, máx.):\\
insira aqui o screenshot da tabela de estatísticas descritivas do notebook
(Seção 3.1)}
...
\tablePlaceholder{Tabela 3.8.2 — Percentis da variável Idade
(P10, Q1, Q2/Mediana, Q3, P90):\\
insira aqui o screenshot da tabela de percentis de idade do notebook
(Seção 3.8.2)}
\label{tab:percentis_age}

\tablePlaceholder{Tabela 3.8.3 — Percentis da variável Tarifa 2024
(P10, Q1, Q2/Mediana, Q3, P90):\\
insira aqui o screenshot da tabela de percentis de tarifa do notebook
(Seção 3.8.3)}
...
\tablePlaceholder{Tabela 3.9 — Coeficiente de correlação de Pearson entre
Idade e Tarifa 2024 ($r$ e \textit{p-value}):\\
insira aqui o screenshot da tabela de correlação do notebook (Seção 3.9)}
\label{tab:pearson}
